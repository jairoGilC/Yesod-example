...
clientId :: Text
clientId = "152725451937-csdn8g087shgm1dcjtqtqftiv26ea1m4.apps.googleusercontent.com"

-- Replace with Google secret ID.
clientSecret :: Text
clientSecret = "4dfh9Q28RvfdHtLpZ3oXoZbN"  
...
instance Yesod App where
    ...
    isAuthorized DemoSearchR  _ = return Authorized
    isAuthorized DemosJsonR  _ = return Authorized

    -- the profile route requires that the user is authenticated, so we
    -- delegate to that function
    isAuthorized ProfileR _ = isAuthenticated

    -- the profile route requires that the user have enough privileges, so we
    -- delegate to that function
